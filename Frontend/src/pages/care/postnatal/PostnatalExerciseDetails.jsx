...
const PostnatalExerciseDetails = () => {
  ...
  useEffect(() => {
    const fetchExerciseData = async () => {
      try {
        ...
        // Find the exercise in the postnatal exercises
        if (data.postnatal_exercises) {
          const foundExercise = data.postnatal_exercises.find(
          ...
          console.error('Postnatal data not found');
        }
      } catch (error) {
    ...
    <Container maxWidth="lg">
      <Box sx={{ py: 4 }}>
        <Button
          ...
          onClick={() => navigate('/care/postnatal/exercises')}
...
export default PostnatalExerciseDetails;
